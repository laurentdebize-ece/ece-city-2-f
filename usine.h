#ifndef ECE_CITY_2_F_USINE_H
#define ECE_CITY_2_F_USINE_H
#include "menu.h"

void dessinerUsines(int *dessin, Case cases[NB_LIGNES_MAX][NB_COLONNES_MAX], Info info, ALLEGRO_FONT *text, ALLEGRO_FONT *textBold,
